    ...
    <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col justify-between gap-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card className="rounded-2xl bg-[#19B6D2] text-white p-0 min-h-[200px]">
            <CardContent className="p-6 flex flex-col h-full">
              <span className="text-4xl font-medium ">2024</span>
              <span className="text-base mt-auto">Business line developed</span>
            </CardContent>
          </Card>
          <Card className="rounded-2xl bg-[#E6F7FA] text-[#19B6D2] p-0 min-h-[200px]">
            <CardContent className="p-6 flex flex-col h-full">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4 min-h-[200px]">
          ...
          <Card className="rounded-2xl bg-[#7ED6E8] text-[#181F1C] flex flex-col p-0 ">
            <CardContent className="p-6 flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="rounded-2xl bg-[#0C4A53] text-white flex flex-col items-start justify-between p-0">
            <CardContent className="p-6 flex flex-col h-full">
              <Image src="/assets/Flask.png" alt="Check" width={24} height={24} className="mb-4" />
          ...
          <div className="space-y-4">
            <div className="rounded-2xl overflow-hidden">
              <Image src="/assets/landing-card2.png" alt="Lab 2" width={150} height={100} className="w-full h-full object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden">
              <Image src="/assets/landing-card3.png" alt="Lab 3" width={150} height={100} className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
