...
export default function Process() {
    return (
        ...
        {/* Left: Title */}
        <div className="w-[50%] flex flex-col justify-between items-stretch">
          <div>
            <span className="text-[#0077A3] text-lg font-medium mb-8 block">Our Process</span>
            <h2 className="text-[#181F1C] text-5xl font-semibold leading-tight mb-4">From our lab to yours</h2>
          </div>
          <Image src="/assets/landing-process.png" alt="Sentinel Box" width={450} height={260} className="object-contain" />
        </div>
        {/* Right: Steps */}
        <div className="w-[50%] pr-12 flex flex-col gap-12">
          {/* Step 1 */}
